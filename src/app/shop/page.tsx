        ...
        <>
            ...
            <section className="relative w-full overflow-hidden bg-black py-10">
                ...
                <div className="absolute inset-0 pointer-events-none">
                    <div className="absolute top-[-30%] left-[-10%] w-[45%] h-[120%] bg-blue-600/15 rounded-full blur-[100px]" />
                    <div className="absolute bottom-[-30%] right-[-5%] w-[40%] h-[120%] bg-purple-600/15 rounded-full blur-[100px]" />
                ...
                <div className="container relative z-10 px-6 mx-auto flex flex-col items-center justify-center text-center gap-4 py-20">
                    ...
                    >
                        ...
                        <p className="text-zinc-400 text-base max-w-lg leading-relaxed">
                            Browse our curated selection of premium products. Quality meets style in every item we carry.
                        </p>
                        {/* Breadcrumb */}
